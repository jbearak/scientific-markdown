...
Documents with Zotero citation field codes are marked as modified by Word on open. This is a Word behavior — Word processes and recalculates citation fields during open, which sets the unsaved-changes flag. This happens regardless of whether the document was generated by Manuscript Markdown, Zotero, or any other tool that uses Word citation field codes.
