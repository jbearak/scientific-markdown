...
![left: a VS Code window with an editor and preview tab showing side-by-side; right: same document in Word](https://raw.githubusercontent.com/jbearak/manuscript-markdown/v1.0.1/sample.png)
